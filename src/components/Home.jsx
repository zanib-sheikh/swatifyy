...
<div className="flex flex-col pr-8 md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6 w-full md:w-[50%]">
  ...
  <button className="p-6 md:p-8 rounded-full border border-purple-600 bg-transparent shadow-inner shadow-pink-500/60 flex items-center justify-center w-16 h-16 md:w-20 md:h-20">
    <img src={mic} alt="mic" className="w-12 h-6 md:w-max md:h-8" />
  </button>
...
<div class="flex flex-col items-center justify-center  p-8">
  ...
  {/* Card 1 */}
  <div className="bg-transparent border border-gray-300 p-6 text-left rounded-2xl shadow-lg shadow-gray-500/50 flex flex-col items-start space-y-2 card">
    <div className="flex flex-col items-start space-y-2">
      <span className="bg-gradient-to-t from-purple-600 to-pink-500 p-2 rounded-full">
        <img src={shuttle} alt="shuttle" className="w-7 h-7" />
      </span>
      <h2 className="text-xl ">Get Started With Minimal Effort</h2>
  ...
  {/* Card 2 */}
  <div className="bg-transparent border border-gray-300 p-6 rounded-2xl text-left shadow-lg shadow-gray-500/50 flex flex-col items-start space-y-2 card">
    <div className="flex flex-col items-start space-y-2">
      <span className="bg-gradient-to-t from-purple-600 to-pink-500 p-2 rounded-full">
        <img src={Call} alt="phone" className="w-7 h-7" />
      </span>
      <h2 className="text-xl">Let Your Agent Handle The Basics</h2>
  ...
  <div className="bg-transparent border border-gray-300 p-6 text-left rounded-2xl shadow-lg shadow-gray-500/50 flex flex-col items-start space-y-2 card">
    <div className="flex flex-col items-start space-y-2">
      ...
      <h2 className="text-xl ">Monitor Key Interactions</h2>
  ...
  <div className="bg-transparent border border-gray-300 p-6 text-left rounded-2xl shadow-lg shadow-gray-500/50 flex flex-col items-start space-y-2">
    <div className="flex flex-col items-start space-y-2">
      ...
      <h2 className="text-xl ">Ongoing Updates & Enhancements</h2>
